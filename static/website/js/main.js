...
(function($) {
  ...
  $(document).ready(function() {
    ...
    $("#booking-form").on('submit', function(e) {
      ...
      $.post('/booking.py', post_data, function(response) {
    ...
    $("#contact-form").on('submit', function(e) {
      ...
      //Ajax post data to server
      $.post('/email.py', post_data, function(response) {
    ...
    $("#subscribe-form").on('submit', function(e) {
      ...
      //Ajax post data to server
      $.post('email/subscribe.py', post_data, function(response) {
...
*/
    ...
    function initialize() {
      var map;
      var panorama;
      var var_latitude = 13.0670864; // Google Map Latitude
      var var_longitude = 77.6414871; // Google Map Longitude
      var pin = '/static/website/images/icons/pin.svg';

      //Map pin-window details
      var title = "Chazing Purple - Click here";
      var hotel_name = "<b>Chazing Purple Solutions Pvt. Ltd.</b>";
      var hotel_address = "Sy. No.21, Dr. K. Narayanpura Village";
      var hotel_desc = "Bangalore, KA - 560077";
      var hotel_more_desc = "Hospitality Services";
